...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    const allServices = {
        ...
        descriptions: {
            ...
            knmask: "These KN95 masks are designed to fit over the nose and mouth of the wearer, and properly fitted can provide excellent protection. A comfortable elastic headband, adjustable nose bridge and single strap construction provide a secure, customized fit; one size fits most faces. N95 is the United States standard, able to filter out 95% of particles as small as 0.3 microns from the air. All mask are FDA certified.",
    ...
    let moreInfo = function(service) {
        ...
        if (serviceId == "learn1") {
            ...
            price11.style.display = "none";
            price12.style.display = "none";
        } else if (serviceId == "learn12") {
            infoTitle.innerHTML = allServices.titles.knmask;
            infoDescrip.innerHTML = allServices.descriptions.knmask;
            extra1.style.display = "none";
            extra2.style.display = "none";
            extra3.style.display = "none";
    ...
    let learn12 = document.getElementById("learn12");
    learn12.onclick = function() {
        moreInfo("learn12");
    }
