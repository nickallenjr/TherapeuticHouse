...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    const allServices = {
        ...
        descriptions: {
            ...
            treat: "We understand that life is hectic and we won’t be able to physically see everyone so we offer various treatment plans. The plan depends on the individual and which holistic approach you would like to take. This plan is for problems with pms, menstruation, cysts, fibroids, stress, depression, inflammation, and metaphysics. This includes a treatment plan and four 40 minute consultations. The first consultation is free."
        },
        prices: {
            lhamo: {
